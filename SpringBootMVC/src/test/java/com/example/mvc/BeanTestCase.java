    ...
    */
        ...
        try {
            ...
            for (int i = 0; i < fields.length; i++) {
                ...
                if (field.getType() == String.class) {
                    ...
                    field.set(o1, field.getType().getDeclaredConstructor().newInstance());
                } else {
                ...
                if (field.getType() == String.class) {
                    ...
                    field.set(o2, field.getType().getDeclaredConstructor().newInstance());
                } else {
                    fail("Don't know how to set a " + field.getType().getName());
                }
    ...
    public static void assertMeetsHashCodeContract(Class<?> classUnderTest,
        ...
        try {
            ...
            for (int i = 0; i < fields.length; i++) {
                Object o1 = classUnderTest.getDeclaredConstructor().newInstance();
